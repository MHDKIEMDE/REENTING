...
<div class="container mt-5">
    <div class="jumbotron">
        <h1 class="display-4">À Propos de [Nom de Votre Site]</h1>
        <p class="lead">Bienvenue sur [Nom de Votre Site], la destination en ligne pour faciliter la recherche de
    ...
    <div class="row mb-5">
        ...
        <div class="col-md-6">
            ...
            <p>Fondé par des experts passionnés d'immobilier et de technologie, [Nom de Votre Site] a émergé de notre
                désir de...</p>
        </div>
    </div>
    ...
    <div class="row mb-5">
        <div class="col-md-6">
            ...
            <div class="card">
                <div class="card-body">
                    <p class="card-text">"Grâce à [Nom de Votre Site], j'ai trouvé la maison de mes rêves en quelques
            ...
            <div class="card mt-3">
                <div class="card-body">
                    <p class="card-text">"En tant que bailleur, [Nom de Votre Site] m'a permis de trouver des locataires
                        qualifiés en un temps record. Je ne pourrais pas être plus satisfait."</p>
