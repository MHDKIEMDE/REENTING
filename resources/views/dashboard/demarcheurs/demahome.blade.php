...
@section('content')
        ...
        <div class="row" style="margin-left: -2%; margin-right:-2%; ">
            ...
            <div class="col-md-4 col-sm-6 d-flex align-items-center justify-content-center">
                <div class="rectange-position-dessus  text-center">
                    <p style="font-size: 34px; line-height: 130%;">Trouvez votre foyer idéal !</p>
                    <p style="font-size:18px ">"Notre objectif : une plateforme de mise en
                        relation simplifiée entre
                        propriétaires et locataires pour des maisons de charme. Une expérience fluide, vous
                        épargnant les démarches fastidieuses, afin de trouver rapidement votre foyer idéal pour
                        des
                        moments inoubliables."
                    </p>
                    <a href="{{ URL::to('/apropos') }}" type="button"
                        class="btn mt-1 text-dark fw-bold hover-zoom border rounded" style="background-color: #F05510;">
                        VOIR PLUS SUR NOUS!</a>
                </div>
            </div>
        </div>
    </section>
    <section>
        ...
        line-height: 130%;">
                            ...
                            devotre futur chez-vous idéal, imprégné de charme et <br> d'authenticité."</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="container m-5 mb-5">
            <div class="row">
                <div class="col-md-2 d-flex mt-5" style="margin-left: 19%">
                    <div style="width: 3%;height: 60%;background-color: #1a1919; margin-top: 5px; "class="barre m-1">
                    </div>
                    <div>
                        <p class=""> WHERE WOULD YOU RATHER LIVE?</p>
                    </div>
                </div>
                <div class="col-md-2 mt-5 fw-bold" style="margin-left: 42%;">
    ...
    <section class="">
        <div class="container mb-4">
            <form id="formulaireFiltrage" action="{{ route('dema.filtrermaisons') }}" method="post">
                @csrf
                                        ...
                                        <div class="card-body border-0">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <h6 style="font-size: 15px">
                                                    {{ number_format($maison->loyer, 0, '.', ' ') }} F CFA</h6>
                                            </div>
                                            ...
                                            <p class="card-text"><i
                                                    class="fa-solid fa-user me-1"></i>{{ $maison->user->name }}</p>
                                        </div>
                                        <div class="card-footer text-center border-dark">
